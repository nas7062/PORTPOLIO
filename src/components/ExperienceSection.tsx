export default function ExperienceSection() {
  return (
    <section
      id="experience"
      className="min-h-screen scroll-mt-20 px-6 md:px-10 lg:px-16 py-10 "
    >
          ...
          <div>
            ...
            <div className="space-y-4 ">
              ...
              <div>
                ...
                <p className="text-sm ">o 렌더링 최적화 및 성능 개선 경험</p>
              </div>
              ...
              <div>
                ...
                <p className="text-sm ">o React Native 기반 모바일 화면 구현 경험</p>
              </div>
            </div>
          </div>
